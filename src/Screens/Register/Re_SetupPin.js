...
export default class SetupPin extends Component {
  ...
  _onPressNumber = num => {
    ...
    if (this.state.passcode[3] !== '') {
      ...
      AsyncStorage.setItem('firstPassCode', this.state.finalCode);
      navigationService.navigate(NAV_TYPES.RE_SETUP_CONFIRM_PIN);
      ...
      <View Style={{flex: 1}}>
        <View style={{backgroundColor: '#2477B2'}}>
          <View
            ...
            <View>
              <Text style={styles.headerText}>SETUP PIN</Text>
            </View>
          </View>
